...
`,
  `Noen mener at sidemål burde være et valgfag fordi mange elever opplever det som unødvendig å lære to nesten like språk, og de har liten nytte av det i hverdagen. Et valgfag ville gjort det mer motiverende for dem som faktisk er interessert, i stedet for å tvinge alle til å bruke tid på det. I en tid hvor engelsk er langt viktigere for de fleste, bør elevene heller få velge fag som oppleves mer relevant for deres utdanning og framtid.
Andre mener at sidemål bør ikke være et valgfag fordi det er en viktig del av norsk kultur, identitet og språkfellesskap. Det sikrer at begge målformer lever videre, og gir respekt for det språklige mangfoldet i landet. Å lære sidemål handler også om å forstå andre mennesker og deler av Norge bedre. Å gjøre det valgfritt kan føre til at færre lærer det, noe som på sikt kan true sidemål som skriftspråk.
