    ...
    <div className="flex flex-col items-center gap-10 text-black">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center">
              <a
                ...
                className={
                  "bg-[#ff6340] font-semibold font-xl text-white px-5 py-2 cursor-pointer hover:opacity-80 transition-opacity duration-200 rounded-4xl flex items-center justify-center gap-1"
                }
              >
                Besøk {topParty.name}
                <svg
      ...
      <ContentCard>
        <div className="w-full max-w-2xl">
          <h2 className="text-lg font-semibold text-center">Andre partier</h2>
            ...
            {remainingParties.map((party, index) => {
              ...
              return (
                <div key={index} className="flex items-center gap-4">
                  ...
                  <div
                    className={`${
                      partyStyles[party.symbol]?.bg || "bg-gray-500"
                    } ${
                      partyStyles[party.symbol]?.text || "text-white"
                    } w-12 h-8 flex items-center justify-center rounded font-semibold text-sm flex-shrink-0`}
                  >
                    {party.symbol}
                  </div>
